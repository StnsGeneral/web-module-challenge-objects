...
const cheeseBurger = createMenuItem("cheese burger", 4, "Dinner")
console.log(pizza, hamburger, cheeseBurger)
...
export const burger = {
  ...
  price: 18,
  category: "Lunch",
  discount: function (reason) {
    if (reason === "teacher" || reason === "student") {
...
reviews.push({
  name: "Jacqueline",
  rating: 4,
  feedback: "This place has some of the best service I have ever recieved at a dining establishment. The food could use a little love though"
})
console.log(reviews)
